...
namespace LXY
{
	...
	void MyInlineHook32::m_InlineHook1() //占用的地方被先调用
	{
		...
		{
			MD_Throw_Handle(MyInlineHook32::m_InlineHook::VirtualProtectEx);
		}
